...
def print_timing_tree(node: Dict[str, Any], indent: int = 0) -> None:
    """
    Pretty print the parsed timing tree.
    """
    if not node:
        return
...
[0] root 0.48496 100.0% 1 0    0.0 MFlops
   ...
   [7] forall_zone 0.00065  0.1% 1 0    0.0 MFlops
   ...
   [13] BoxData::setVal 0.00003  0.0% 4 0    0.0 MFlops
    ...
    # forall_zone_timer = find_timer_by_name(timing_data, 'root')

    # if forall_zone_timer:
    #     print("\n" + "="*50 + "\n")
    ...
    # else:
    #     print("Timer 'forall_zone' not found")